...
public class GradeManagementGUI extends JFrame {
    ...
    private void initializeGUI() {
        ...
        // Create menu bar with black text
        createMenuBar();
    ...
    private void createMenuBar() {
        ...
        menuBar.setBackground(new Color(173, 216, 230)); // Light blue background
        
        JMenu fileMenu = new JMenu("File");
        fileMenu.setForeground(Color.BLACK); // Menu text BLACK
        
        JMenuItem exitItem = new JMenuItem("Exit");
        exitItem.setForeground(Color.BLACK); // Menu item text black
        exitItem.addActionListener(e -> System.exit(0));
        fileMenu.add(exitItem);
        
        JMenu helpMenu = new JMenu("Help");
        helpMenu.setForeground(Color.BLACK); // Menu text BLACK
        
        JMenuItem aboutItem = new JMenuItem("About");
        aboutItem.setForeground(Color.BLACK); // Menu item text black
    ...
    private void createStudentTable() {
        ...
        // Table header styling - BLACK text on light blue background
        studentTable.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        studentTable.getTableHeader().setBackground(new Color(173, 216, 230)); // Light blue
        studentTable.getTableHeader().setForeground(Color.BLACK); // BLACK text for ID, Name, Average, etc.
        studentTable.getTableHeader().setReorderingAllowed(false);
        
        // Make sure header renderer uses black text
        studentTable.getTableHeader().setDefaultRenderer(new javax.swing.table.DefaultTableCellRenderer() {
            @Override
        ...
        studentTable.setForeground(Color.BLACK); // All table text BLACK
        studentTable.setSelectionBackground(new Color(173, 216, 230));
        studentTable.setSelectionForeground(Color.BLACK); // BLACK text even when selected
        ...
        studentTable.setDefaultRenderer(Object.class, new javax.swing.table.DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (!isSelected) {
                    ...
                    c.setForeground(Color.BLACK); // BLACK text even when selected
                }
                
                // Color code the grade column with colored text on white/light backgrounds
                ...
                if (column == 0 || column == 2 || column == 3 || column == 4 || column == 5) {
                    ...
                    ((JLabel) c).setHorizontalAlignment(SwingConstants.LEFT); // Name left aligned
                }
    ...
    private JButton createStyledButton(String text, Color color) {
        ...
        button.setForeground(Color.BLACK); // BLACK text on light backgrounds
    ...
    private void createDetailsPanel() {
        ...
        detailsArea.setForeground(Color.BLACK); // BLACK text
    ...
    private void createStatisticsPanel() {
        ...
        statsLabel.setBackground(new Color(220, 230, 240)); // Light blue background
        statsLabel.setForeground(Color.BLACK); // BLACK text
    ...
    private void addGradesDialog() {
        ...
        studentCombo.setForeground(Color.BLACK);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            // Set system colors for better visibility - BLACK TEXT EVERYWHERE
            ...
            UIManager.put("MenuBar.background", new Color(173, 216, 230));
            UIManager.put("TableHeader.foreground", Color.BLACK);
            UIManager.put("TableHeader.background", new Color(173, 216, 230));
